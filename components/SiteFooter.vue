<template>
  <footer class="border-t border-white/10 bg-black">
    <BaseContainer>
      <div
        class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 py-12 md:py-16"
      >
        <!-- Hotel Info -->
        <div>
          ...
          <div class="flex items-center gap-4">
            <a href="#" class="text-white/60 hover:text-gold transition-colors">
        ...
        <div>
          ...
          <ul class="space-y-3 text-sm text-white/70">
            <li class="flex items-start gap-3">
              <svg
                class="h-5 w-5 text-gold mt-0.5 flex-shrink-0"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <span>12 Rue de Lumière<br />75001 Paris, France</span>
            </li>
        ...
        <div>
          ...
          <form class="space-y-3">
            <input
              ...
              class="w-full rounded-lg bg-white/10 border border-white/20 px-4 py-2.5 text-sm text-white placeholder-white/50 focus:outline-none focus:border-gold focus:ring-2 focus:ring-gold/20 transition-all"
            />
            <button
              type="submit"
              class="w-full rounded-lg bg-gold px-4 py-2.5 text-sm font-semibold text-black hover:bg-white transition-colors"
            >
              Subscribe
            </button>
          </form>
